 ...
 * @author Paulo Soares
 */
public class JPKIPdfStamper
	implements PdfViewerPreferences, PdfEncryptionSettings {
    /**
     * The writer
     */
    protected JPKIPdfStamperImp stamper;
    private HashMap<String, String> moreInfo;
    private boolean hasSignature;
    private JPKIPdfSignatureAppearance sigApp;
     ...
     * @throws IOException on error
     */
    public JPKIPdfStamper(PdfReader reader, OutputStream os, char pdfVersion) throws DocumentException, IOException {
        stamper = new JPKIPdfStamperImp(reader, os, pdfVersion, false);
    }
     ...
     * @throws IOException on error
     */
    public JPKIPdfStamper(PdfReader reader, OutputStream os, char pdfVersion, boolean append) throws DocumentException, IOException {
        stamper = new JPKIPdfStamperImp(reader, os, pdfVersion, append);
    }
     ...
     */
    public JPKIPdfSignatureAppearance getSignatureAppearance() {
        return sigApp;
    }
    ...
    public void close() throws DocumentException, IOException {
        ...
        sigApp.preClose();
        JPKIPdfSigGenericPKCS sig = sigApp.getSigStandard();
