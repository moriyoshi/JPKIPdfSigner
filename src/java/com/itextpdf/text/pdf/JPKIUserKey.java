...
public class JPKIUserKey implements Closeable {
    ...
    public JPKIUserCertificate getCertificate() throws JPKIWrapperException {
    	try {
            final byte[] encoded = JPKIWrapper.impl.cryptGetCertificateValue(handle);
    		return new JPKIUserCertificate(JPKIWrapper.generateCertificate(encoded), encoded);
    	} catch (Exception e) {
    		throw new JPKIWrapperException(e);
    	}
    }
