...
class JPKIPdfStamperImp extends PdfWriter {
     ...
     * @throws IOException
     */
    JPKIPdfStamperImp(PdfReader reader, OutputStream os, char pdfVersion, boolean append) throws DocumentException, IOException {
    ...
    PdfContentByte getUnderContent(int pageNum) {
        ...
        if (ps.under == null)
            ps.under = new JPKIStampContent(this, ps);
        return ps.under;
    }
    ...
    PdfContentByte getOverContent(int pageNum) {
        ...
        PageStamp ps = getPageStamp(pageNum);
        if (ps.over == null)
            ps.over = new JPKIStampContent(this, ps);
        return ps.over;
    }
...
//        reader.getCatalog().remove(PdfName.ACROFORM);
    ...
    /**
     * @see com.itextpdf.text.pdf.JPKIPdfWriter#getPageReference(int)
     */
    @Override
    ...
    /**
     * @see com.itextpdf.text.pdf.JPKIPdfWriter#addAnnotation(com.itextpdf.text.pdf.PdfAnnotation)
     */
    @Override
    ...
    void addFieldResources() throws IOException {
        ...
        for (PdfTemplate template: fieldTemplates) {
            mergeResources(dr, (PdfDictionary)template.getResources(), this);
        }
     ...
     * @see JPKIPdfWriter#setViewerPreferences(int)
     */
    @Override
     ...
     * @param actionType the action type. It can be <CODE>JPKIPdfWriter.PAGE_OPEN</CODE>
     * or <CODE>JPKIPdfWriter.PAGE_CLOSE</CODE>
    ...
    /**
     * @see com.itextpdf.text.pdf.JPKIPdfWriter#setOpenAction(com.itextpdf.text.pdf.PdfAction)
     */
    @Override
    ...
    /**
     * @see com.itextpdf.text.pdf.JPKIPdfWriter#setOpenAction(java.lang.String)
     */
    @Override
    ...
    /**
     * @see com.itextpdf.text.pdf.JPKIPdfWriter#setThumbnail(com.itextpdf.text.Image)
     */
    @Override
     ...
     * and fills the documentOCG, documentOCGorder and OCGRadioGroup variables in JPKIPdfWriter.
    ...
    static void mergeResources(PdfDictionary result, PdfDictionary source, JPKIPdfStamperImp writer) {
    ...
    static class PageStamp {
        ...
        PdfDictionary pageN;
        JPKIStampContent under;
        JPKIStampContent over;
        PageResources pageResources;
        int replacePoint = 0;

        PageStamp(JPKIPdfStamperImp stamper, PdfReader reader, PdfDictionary pageN) {
            this.pageN = pageN;
